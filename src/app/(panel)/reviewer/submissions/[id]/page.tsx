        ...
        <section className="space-y-6 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <Card className="border-primary/5 shadow-vip overflow-hidden sticky top-24 rounded-xl bg-white">
                        <CardHeader className="p-8 bg-primary/5 border-b border-primary/5">
                            <div className="space-y-4">
                                <Badge className="h-6 px-3 text-[9px] sm:text-[10px] xl:text-[11px] 2xl:text-xs font-black tracking-[0.2em] bg-emerald-500 text-white border-none shadow-sm rounded-lg uppercase">
                                    Assigned for Review
                                </Badge>
                                <CardTitle className="text-xl sm:text-2xl lg:text-3xl xl:text-4.5xl 2xl:text-5xl font-black text-primary tracking-wider leading-wider dark:text-black">
                                    {submission.title}
                                </CardTitle>
                                <div className="flex flex-wrap items-center gap-6 text-[10px] font-black text-primary/40 dark:text-black tracking-[0.2em] uppercase">
                        ...
                        <CardContent className="p-8 space-y-8">
                            <div className="space-y-4">
                                <h4 className=" font-black text-primary/40 tracking-[0.2em] dark:text-green-900 flex items-center gap-3 uppercase">
                                    <FileText className="w-5 h-5" /> Abstract
                                </h4>
                                <p className="text-sm text-primary/70 leading-relaxed font-medium text-justify italic dark:text-red-700">
                            ...
                            <div className="pt-4">
                                {submission.pdf_url ? (
                                    <>
                                        <Button asChild className="w-full h-12 gap-3 font-bold text-[11px] tracking-widest shadow-xl shadow-primary/20 rounded-xl bg-primary hover:opacity-90 transition-all uppercase cursor-pointer text-white dark:text-black">
                                            <a href={submission.pdf_url} download>
                                                <Download className="w-4 h-4" /> Download PDF
                                            </a>
                                        </Button>
                                        <p className="text-[10px] font-bold text-primary/30 text-center mt-4 tracking-widest uppercase">
